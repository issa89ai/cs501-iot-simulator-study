...
#define TIMESTAMP_CACHE_SIZE 16

static struct broadcast_conn broadcast;
static clock_time_t last_timestamp = 0;
static clock_time_t timestamp_cache[TIMESTAMP_CACHE_SIZE] = {0};

PROCESS(pingpong, "Ping Pong Process");
AUTOSTART_PROCESSES(&pingpong);

static void broadcast_recv(struct broadcast_conn *c, const rimeaddr_t *from) {
    clock_time_t received_timestamp = *((clock_time_t *)packetbuf_dataptr());
    int i, cache_index = -1;
